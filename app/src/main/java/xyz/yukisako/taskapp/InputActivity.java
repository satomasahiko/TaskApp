...
public class InputActivity extends AppCompatActivity {
    ...
    private View.OnClickListener mOntimeClickListener = new View.OnClickListener(){
        @Override
        public void onClick(View v){
            TimePickerDialog timerPickerDialog = new TimePickerDialog(InputActivity.this,
                    new TimePickerDialog.OnTimeSetListener(){
                        @Override
                        public void onTimeSet(TimePicker view, int hourOfDay, int minite){
                            mHour = hourOfDay;
                            mMinute = minite;
                            String timeString = String.format("%02d",mHour)+":"+String.format("%02d",minite);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //EXTRA_TASKからTASKのidを取得して，idからTaskのインスタンスを取得
